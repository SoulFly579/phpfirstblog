...
<section id="contact" class="md-padding">
	...
	if(isset($_POST["sendmessage"])){
		...
		try{
					...
					$mail->setFrom("iletisim.blogw@gmail.com", $_POST["name"]);
					$mail->addAddress("soulfly579@gmail.com", "Contact Form");
					$mail->isHTML(true);
					...
					* {
					...
					<!--<![endif]-->
						<table class='wrapper' style='border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #fff;' cellpadding='0' cellspacing='0' role='presentation'><tbody><tr><td>
						  <div role='banner'>
							...
							<!--[if (mso)|(IE)]><table align='center' class='header' cellpadding='0' cellspacing='0' role='presentation'><tr><td style='width: 600px'><![endif]-->
							  <div class='logo emb-logo-margin-box' style='font-size: 26px;line-height: 32px;Margin-top: 6px;Margin-bottom: 20px;color: #41637e;font-family: Avenir,sans-serif;Margin-left: 20px;Margin-right: 20px;' align='center'>
								<div class='logo-center' align='center' id='emb-email-header'><img style='display: block;height: auto;width: 100%;border: 0;max-width: 300px;' src='images/yalarmfoto.jpeg' alt='' width='300' /></div>
							  </div>
							<!--[if (mso)|(IE)]></td></tr></table><![endif]-->
							</div>
						  </div>
						  ...
						  <div style='mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;'>
							<h1 style='Margin-top: 0;Margin-bottom: 20px;font-style: normal;font-weight: normal;color: #000;font-size: 26px;line-height: 34px;font-family: Times,Times New Roman,serif;text-align: center;'>&#304;leti&#351;im Formu</h1>
						  </div>
						</div>
						  ...
						  <div class='layout one-col fixed-width stack' style='Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;'>
							...
							<!--[if (mso)|(IE)]><table align='center' cellpadding='0' cellspacing='0' role='presentation'><tr class='layout-fixed-width' style='background-color: #ffffff;'><td style='width: 600px' class='w560'><![endif]-->
							  <div class='column' style='text-align: left;color: #000;font-size: 16px;line-height: 24px;font-family: Verdana,sans-serif;'>
								...
								<div style='Margin-left: 20px;Margin-right: 20px;'>
						  <div style='mso-line-height-rule: exactly;line-height: 78px;font-size: 1px;'>&nbsp;</div>
						</div>
							
								<div style='Margin-left: 20px;Margin-right: 20px;'>
						  <div style='mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;'>
							<p style='Margin-top: 0;Margin-bottom: 20px;'>{$_POST['message']}</p>
						  </div>
						</div>
						  ...
						  <div class='divider' style='display: block;font-size: 2px;line-height: 2px;Margin-left: auto;Margin-right: auto;width: 40px;background-color: #ccc;Margin-bottom: 20px;'>&nbsp;</div>
								...
								<div style='Margin-left: 20px;Margin-right: 20px;'>
						  <div style='mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;'>
							<p style='Margin-top: 0;Margin-bottom: 0;'>{$_POST['phone']}</p>
						  </div>
						</div>
						  ...
						  <div role='contentinfo'>
							<div class='layout email-footer stack' style='Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;'>
							  ...
							  <!--[if (mso)|(IE)]><table align='center' cellpadding='0' cellspacing='0' role='presentation'><tr class='layout-email-footer'><td style='width: 400px;' valign='top' class='w360'><![endif]-->
								<div class='column wide' style='text-align: left;font-size: 12px;line-height: 19px;color: #151513;font-family: Verdana,sans-serif;Float: left;max-width: 400px;min-width: 320px; width: 320px;width: calc(8000% - 47600px);'>
							  ...
							  <!--[if (mso)|(IE)]></td><td style='width: 200px;' valign='top' class='w160'><![endif]-->
								<div class='column narrow' style='text-align: left;font-size: 12px;line-height: 19px;color: #151513;font-family: Verdana,sans-serif;Float: left;max-width: 320px;min-width: 200px; width: 320px;width: calc(72200px - 12000%);'>
								  <div style='Margin-left: 20px;Margin-right: 20px;Margin-top: 10px;Margin-bottom: 10px;'>
							...
							<div class='layout one-col email-footer' style='Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;'>
							  ...
							  <!--[if (mso)|(IE)]><table align='center' cellpadding='0' cellspacing='0' role='presentation'><tr class='layout-email-footer'><td style='width: 600px;' class='w560'><![endif]-->
								<div class='column' style='text-align: left;font-size: 12px;line-height: 19px;color: #151513;font-family: Verdana,sans-serif;'>
								  <div style='Margin-left: 20px;Margin-right: 20px;Margin-top: 10px;Margin-bottom: 10px;'>
					...
					"; 
					if($mail->send()){
						echo '<h1>Mesaj Gönderimi Başarılı</h1>>';
						header("Location: index.php");
					}else{
						echo '<h1>Mesaj Gönderimi Başarısız</h1>';
						header("Location: index.php");
					}
		}catch (Exception $e) {
			echo $e->getMessage();
				...
				<form id="contactForm" action="" method="post" >
					<div class="row">
						...
						<div class="col-lg-12 text-center">
							<div id="success"></div>
							<button id="sendMessageButton" class="main-btn" type="submit" name="sendmessage">Send Message</button>
						</div>
					</div>
				</form>
			</div>
