        ...
        <div class="container-fluid">
            ...
            <?php
                if(isset($_GET["approved"])){
                    ...
                    $query2 = "UPDATE comments SET comment_status = 'approved' WHERE comment_id = {$the_comment_id}";

                    $approve_comment_query = mysqli_query($conn, $query2);
                ...
                <?php
                    if(isset($_GET["unapproved"])){
                        ...
                        $query2 = "UPDATE comments SET comment_status = 'unapproved' WHERE comment_id = {$the_comment_id}";

                        $unapprove_comment_query = mysqli_query($conn, $query2);
                        header("Location: comments.php");
                    };
            ...
            <?php
                if(isset($_GET["delete"])){
                    ...
                    $delete_comment_query = mysqli_query($conn, $query2);
                    header("Location: comments.php");
                };
