        ...
        <table class="table table-bordered">
            ...
            <?php
                ...
                while ($row = mysqli_fetch_assoc($select_all_portfolios)){
                    ...
                    <td><img src='../img/$portfolio_img_sm' width='200px' height='200px'></td>
                    <td><img src='../img/$portfolio_img_bg' width='200px' height='200px'></td>
                    <td>
                        <div class='dropdown'>
                            ...
                            <div class="modal-body">
                                <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select style="margin-left:15px; padding:5px;" class="form-group" name="portfolio_category">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="" method="post" enctype = "multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label for="portfolio_category">Portfolio  Category</label></br>
                                        <select style="margin-left:15px; padding:5px;" class="form-group" name="portfolio_category">
